...
- Current full test baseline after these reader tests: `go test ./...` reports 149 passed, 15 failed, 1 skipped. Remaining failures are the pre-existing language output and visual compatibility failures.
...
- [ ] Add reader methods and structs for commits/file history if needed by downstream modes.
...
- [ ] Reader tests cover all report payloads with real `../hercules` fixtures.
